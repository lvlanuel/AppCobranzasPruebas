...
public class lista_clientes_pya extends AppCompatActivity {
    ...
    String usuario_reg,id_cliente, nombre_cliente, apellido_paterno_cliente, apellido_materno_cliente, ci_nit_cliente, email_cliente;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_clientes_pya);


        //incluimos el tool_bar
        toolbar=(Toolbar)findViewById(R.id.tool_bar);
        toolbar.setTitleTextColor(Color.parseColor("#FFFFFF"));
        toolbar.setTitle("Selección de Cliente Pedidos YA");
        ...
        lista_clientes_pya.SegundoPlano tarea = new lista_clientes_pya.SegundoPlano();
        tarea.execute();

        lista_clientes_pya.TercerPlano tarea3 = new lista_clientes_pya.TercerPlano();
        tarea3.execute();
...
*/
        String SOAP_ACTION = "http://ws.sudseguros.com/SearchCustomerPEDYA";
        String METHOD_NAME = "SearchCustomerPEDYA";
        String NAMESPACE = "http://ws.sudseguros.com/";
    ...
    private class TercerPlano extends AsyncTask<Void, Void, Void> {
        ...
        public void ejecutar_pre_amortizacion_listado(View view){
            //Intent es como evento, debe mejecutar el java infoClase
            Intent i=new Intent(getApplicationContext(), EmisionRecPedya.class);
    ...
    public void BorrarBasesDatos() {
        ...
        lista_clientes_pya.TareaEliminarPreCuotas tarea3 = new lista_clientes_pya.TareaEliminarPreCuotas();
        tarea3.execute();
