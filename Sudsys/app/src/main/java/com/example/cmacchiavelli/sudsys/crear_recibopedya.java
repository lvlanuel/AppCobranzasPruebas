...
public class crear_recibopedya extends AppCompatActivity {
    ...
    Spinner tipo_cliente,extension;
    Spinner spinner,spinner2;

    //variables globales

    String usuario_reg,id_sucursal, id_empleado, spTipoCliente, parametro_tipo, mensaje_amortizacion, respuesta_amortizacion, mensaje, estado_habilitado, combo_tipo_busqueda,respuesta_pya,mensaje_pya;
    //para el webservice
    SoapObject resultString,resultString2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear_recibopedya);
        ...
        //String[] letra = {"Natural","Juridico","Nuevo"};
        String[] letra = {"Natural","NUEVO CLIENTE"};

        spinner.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, letra));

        //combobox
        spinner2 = (Spinner) findViewById(R.id.exten);
        //String[] letra = {"Natural","Juridico","Nuevo"};
        String[] letra2 = {"LP","CBBA","OR","TJ","PO","CS","BE","PA","CHE","EXT"};
        ...
        usuario_reg=datos.getString("parametro_usuario_recibido");


        //vemos si el usuario esta habilitado en el sudsys
        crear_recibopedya.VerificaUsuarioPlano tarea3 = new crear_recibopedya.VerificaUsuarioPlano();
        tarea3.execute();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if(spTipoCliente.equals("NUEVO CLIENTE")) {
                    ...
                    TextView textcargando15 = (TextView) findViewById(R.id.textViewTipo);
                    textcargando15.setVisibility(View.VISIBLE);
                    Spinner textcargando16 = (Spinner) findViewById(R.id.exten);
                    textcargando16.setVisibility(View.VISIBLE);
                    ...
                    if (spTipoCliente.equals("Natural")) {
                        ...
                        TextView textcargando15 = (TextView) findViewById(R.id.textViewTipo);
                        textcargando15.setVisibility(View.GONE);
                        Spinner textcargando16 = (Spinner) findViewById(R.id.exten);
                        textcargando16.setVisibility(View.GONE);
    ...
    public void lista_clientes(View view){
        if (!compruebaConexion(getApplicationContext())) {
            ...
            if (spTipoCliente.equals("Liquidacion")) {
                ...
                //Intent es como evento, debe mejecutar el java infoClase
                Intent i = new Intent(this, lista_clientes_pya.class);
                ...
                i.putExtra("usuario_reg", usuario_reg.toString());
    ...
    public void lista_clientes2(){
            ...
            txt_numero_liquidacion = (EditText) findViewById(R.id.txt_liquidacion);
                ...
                i.putExtra("parametro_apellido_materno", txt_apellido_materno.getText().toString());
                i.putExtra("parametro_ci_nit", txt_ci_nit.getText().toString());
                i.putExtra("parametro_tipo_cliente"," Natural");
                i.putExtra("parametro_numero_liquidacion", txt_numero_liquidacion.getText().toString());
    ...
    public void ejecutar_polizas_clientes(View view){
        //Intent es como evento, debe mejecutar el java infoClase
        Intent i=new Intent(getApplicationContext(), lista_clientes_pya.class);
    ...
    public void guardaInfo(View view)  {
        ...
        if(txt_ci_nit.getText().toString().trim().isEmpty()){
            Toast.makeText(getApplicationContext(), "Debe ingresar el CI/NIT.", Toast.LENGTH_LONG).show();
        }else {
            if(txt_nombre.getText().toString().trim().isEmpty()){
                Toast.makeText(getApplicationContext(), "Debe ingresar el Nombre.", Toast.LENGTH_LONG).show();
            }else {
                crear_recibopedya.primerPlanoGuarda tarea = new crear_recibopedya.primerPlanoGuarda();
                tarea.execute();
                spinner.setSelection(0);
                //Toast.makeText(getApplicationContext(), mensaje_pya, Toast.LENGTH_LONG).show();
    ...
    public void BorrarBasesDatos() {
        ...
        crear_recibopedya.TareaEliminarPreCuotas tarea3 = new crear_recibopedya.TareaEliminarPreCuotas();
        tarea3.execute();
    ...
    private void guardacliente() {
        String SOAP_ACTION = "http://ws.sudseguros.com/RegistrarClienteNatural";
        String METHOD_NAME = "RegistrarClienteNatural";
        ...
        String txt_nombre1 = txt_nombre.getText().toString() ;
        String txt_apellido_paterno1 = txt_apellido_paterno.getText().toString();
        String  txt_apellido_materno1 = txt_apellido_materno.getText().toString() ;
        String txt_ci_nit1 = txt_ci_nit.getText().toString() ;
        String extension1 = spinner2.getSelectedItem().toString();
        ...
        try {
          ...
          /*  RequestWs.addProperty("id_empleado", id_empleado);
            RequestWs.addProperty("cliente_ci", txt_ci_nit.getText().toString() );
            RequestWs.addProperty("cliente_nombre",txt_nombre.getText().toString() );
            RequestWs.addProperty("cliente_apellido_paterno", txt_apellido_paterno.getText().toString());
            RequestWs.addProperty("cliente_apellido_materno",txt_apellido_materno.getText().toString() );
            RequestWs.addProperty("cliente_extension",extension.getSelectedItem().toString() );
*/

            RequestWs.addProperty("id_empleado", id_empleado);
            RequestWs.addProperty("cliente_ci", txt_ci_nit1 );
            RequestWs.addProperty("cliente_nombre",txt_nombre1 );
            RequestWs.addProperty("cliente_apellido_paterno", txt_apellido_paterno1);
            RequestWs.addProperty("cliente_apellido_materno",txt_apellido_materno1 );
            RequestWs.addProperty("cliente_extension",extension1 );
            ...
            resultString2 = (SoapObject) soapEnvelope.getResponse(); //SoapPrimitive resultado simple, SoapObjet mas complejo
            respuesta_pya = "" + resultString2.getProperty(0);
            mensaje_pya = "" + resultString2.getProperty(1);


        } catch (Exception ex) {
            mensaje_pya = "ERROR 13: " + ex.getMessage();
        }
    }

    private class primerPlanoGuarda extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute(){
            ...
            dialog = new ProgressDialog(crear_recibopedya.this);
        ...
        protected void onPostExecute(Void result){
            ...
            dialog.setMessage(mensaje_pya);
            dialog.hide();
            Toast.makeText(getApplicationContext(),mensaje_pya,Toast.LENGTH_SHORT).show();
